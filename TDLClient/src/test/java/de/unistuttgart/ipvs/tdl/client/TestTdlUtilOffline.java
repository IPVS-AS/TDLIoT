...
public class TestTdlUtilOffline {
	...
	@Test(expected = IllegalArgumentException.class)
	public void testGetTopicDescriptionsWithNullIdList() {
		tdlUtil.getTopicDescriptionsWithIds(null);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testGetTopicDescriptionsWithoutIds() {
		tdlUtil.getTopicDescriptionsWithIds(new ArrayList<String>());
	}
	...
	@Test(expected = IllegalArgumentException.class)
	public void testSearchTopicDescriptionsWithWrongFormattedJSONString() {
		tdlUtil.searchTopicDescriptions(" test ");
	}
	...
	private void mockTopicServerRequest() {
		...
		try {
			...
			doReturn("11111111111111111111111a").when(tdlUtil, "sendPostRequest", contains("add"),
					eq("{\"data_type\":\"boolean\",\"hardware_type\":\"Sensor 123\"}"));

			doReturn("").when(tdlUtil, "sendPostRequest", contains("search"), anyString());
			doReturn("[{\"hardware_type\":\"Sensor 123\"},{\"hardware_type\":\"Test Sensor\"}]").when(tdlUtil, "sendPostRequest", contains("search"),
					eq("{\"filters\":{\"data_type\":\"int\"}}"));
