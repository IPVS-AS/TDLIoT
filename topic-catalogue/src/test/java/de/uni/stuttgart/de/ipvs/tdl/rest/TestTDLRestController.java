...
public class TestTDLRestController {
	...
	public void testDeleteTopicFails() {
		...
		assertEquals(new ResponseEntity<HttpStatus>(HttpStatus.INTERNAL_SERVER_ERROR),
				restController.deleteTopic(dummyID));
	}
	...
	public void testUpdateTopic() {
		...
		assertEquals(new ResponseEntity<HttpStatus>(HttpStatus.ACCEPTED),
				restController.updateTopic(dummyID, dummyUpdateJson));
	}
	...
	public void testUpdateTopicMalformedJson() {
		assertEquals(new ResponseEntity<HttpStatus>(HttpStatus.BAD_REQUEST),
				restController.updateTopic(dummyID, "}"+dummyUpdateJson));
	}
